...
SEARCH_TYPE = ["str", "i8", "i16", "i32", "i64", "u32", "u64", "f32", "f64"]
    ...
    match ori_value_info["type"]:
        ...
        case "i16":
            if ori_value_info["value"] > MAX_I16 or ori_value_info["value"] < -MAX_I16:
                print("`i16` only supports 4-byte values. Use `i32` for larger values.", file=sys.stderr)
                return FAILURE
